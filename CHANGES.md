...
- [FIX] go のバージョンを 1.26.2 に上げる
  - @voluntas

## 2026.1.1

- [FIX] go のバージョンを 1.26.1 に上げる
  - @voluntas
...
- [UPDATE] go のバージョンを 1.24.4 に上げる
  - @voluntas
- [FIX] type: connected のメッセージを受信した際にエラーログを出力しているのを修正する
  - @voluntas
